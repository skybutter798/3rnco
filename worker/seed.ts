...
export const productionGallerySeeds = [
  [
    "gallery-brand-ritual",
    "/images/instagram/brand-ritual.jpg",
    "3R&Co Body Cream, Body Oil and cleansing bar with green fruit and botanicals",
    "Care began at home.",
    "https://www.instagram.com/3rnco/p/DbdV8N1iT0h/",
  ],
  [
    "gallery-body-oil",
    "/images/instagram/body-oil.jpg",
    "Full-size and travel Tree Body Oil bottles among fresh green fruit",
    "Two sizes. One familiar ritual.",
    "https://www.instagram.com/3rnco/p/Dbdbei4CVva/",
  ],
  [
    "gallery-family-care",
    "/images/instagram/family-care.jpg",
    "A woman applying body oil during a quiet family-care moment",
    "Care, held close.",
    "https://www.instagram.com/3rnco/p/Dbrmj6hCee8/",
  ],
  [
    "gallery-oil-texture",
    "/images/instagram/oil-texture.jpg",
    "A 3R&Co Tree Body Oil pump bottle being used",
    "A little warmth, returned to skin.",
    "https://www.instagram.com/3rnco/p/Dbdbei4CVva/",
  ],
  [
    "gallery-story-products",
    "/images/instagram/story-products.jpg",
    "3R&Co products with the words Made for one, now shared with the right ones",
    "Made for one. Shared with the right ones.",
    "https://www.instagram.com/3rnco/p/DbesZwppgDA/",
  ],
  [
    "gallery-care-home",
    "/images/instagram/care-began-home.jpg",
    "3R&Co body ritual products with the words Began at home",
    "Two textures. One complete ritual.",
    "https://www.instagram.com/3rnco/p/DbdV8N1iT0h/",
  ],
  [
    "gallery-body-cream",
    "/images/instagram/body-cream.jpg",
    "Golden botanical oil in a shallow bowl with a wooden spoon",
    "Botanical oil, slowly gathered.",
    "https://www.instagram.com/3rnco/p/Dbdbei4CVva/",
  ],
  [
    "gallery-heritage",
    "/images/instagram-more/heritage-reel.jpg",
    "3R&Co small travel oil in a warm home interior",
    "The small ritual, kept close.",
    "https://www.instagram.com/3rnco/reel/C-Uvs3RSHZE/",
  ],
  [
    "gallery-care",
    "/images/instagram-more/care-reel.jpg",
    "3R&Co body-care texture being massaged into skin",
    "Feel the wonder in every layer.",
    "https://www.instagram.com/3rnco/reel/Cd-P866p5CK/",
  ],
  [
    "gallery-ritual",
    "/images/instagram-more/ritual-reel.jpg",
    "3R&Co Body Cream and Tree Body Oil together",
    "Two textures, one decision.",
    "https://www.instagram.com/3rnco/reel/DEPZlQiSBJ3/",
  ],
  [
    "gallery-moringa",
    "/images/instagram-more/moringa-reel.jpg",
    "3R&Co green botanical product packaging",
    "Hello to a botanical favourite.",
    "https://www.instagram.com/3rnco/reel/CsXeNU5s0LG/",
  ],
] as const;
...
export async function seedProductionDatabase(db: D1Database): Promise<void> {
  const existingSeed = await db
    .prepare(
      "SELECT value FROM app_state WHERE key = 'production_content_seed'",
    )
    .first<{ value: string }>();
  if (existingSeed?.value === "1") {
    await ensureGiftBundle(db);
    return;
  }

  const adminExists = await db
    .prepare("SELECT id FROM users WHERE username_normalized = 'admin' LIMIT 1")
    .first<{ id: string }>();
  if (!adminExists) {
  ...
  const statements: D1PreparedStatement[] = [
    ...
    db.prepare(
      "INSERT OR IGNORE INTO social_links (id, platform, handle, url, enabled, sort_order) VALUES ('social-instagram', 'instagram', '@3rnco', 'https://www.instagram.com/3rnco', 1, 1)",
    ),
    db.prepare(
      "INSERT OR IGNORE INTO social_links (id, platform, handle, url, enabled, sort_order) VALUES ('social-facebook', 'facebook', 'officially3randco', 'https://www.facebook.com/officially3randco/', 1, 2)",
    ),
    db.prepare(
      "INSERT OR IGNORE INTO pages (id, slug, title, status) VALUES ('page-home', 'home', '3R&Co Home', 'PUBLISHED')",
    ),
    db.prepare(
      "INSERT OR IGNORE INTO sliders (id, slug, name, enabled) VALUES ('slider-moringa', 'moringa-campaign', 'Moringa campaign', 1)",
    ),
    db.prepare(
    ...
    db.prepare(`INSERT OR IGNORE INTO bundles
      (id, slug, name, title, cta_label, description, selection_mode, pricing_mode, status, sort_order)
      VALUES ('gift-set', 'gift-set', 'Build a gift set', 'Gather three gestures of care.', 'Build a gift set',
      'Choose a cleansing companion, a nourishing layer, and something to carry close.',
      'MIX_MATCH', 'SUM_ITEMS', 'ACTIVE', 2)`),
    db.prepare(`INSERT OR IGNORE INTO bundle_steps
      (id, bundle_id, step_number, name, prompt, min_selections, max_selections, required, sort_order)
      VALUES ('gift-set-cleanse', 'gift-set', 1, 'Step one · Cleanse', 'Begin the gift with a grounding cleanse.', 1, 1, 1, 1)`),
    db.prepare(`INSERT OR IGNORE INTO bundle_steps
      (id, bundle_id, step_number, name, prompt, min_selections, max_selections, required, sort_order)
      VALUES ('gift-set-care', 'gift-set', 2, 'Step two · Care', 'Choose a cream or full-size botanical oil.', 1, 1, 1, 2)`),
    db.prepare(`INSERT OR IGNORE INTO bundle_steps
      (id, bundle_id, step_number, name, prompt, min_selections, max_selections, required, sort_order)
      VALUES ('gift-set-carry', 'gift-set', 3, 'Step three · Carry', 'Add a travel ritual for care away from home.', 1, 1, 1, 3)`),
  ];
  ...
  const sectionSeeds = [
    [
      ...
      "Moringa-led body care, made in Malaysia for slower everyday moments.",
      1,
    ],
    [
      "section-story",
      ...
      "editorial",
      "Care began at home.",
      "3R&Co grew from a familiar instinct: to care for the people closest to us with ingredients and rituals that feel grounded.",
      2,
    ],
    [
      "section-collection",
      "collection",
      "products",
      "Four ways to return to care.",
      "Explore cleansing, hydration and botanical oil textures for home and travel.",
      3,
    ],
    [
      "section-ritual",
      "ritual",
      "editorial",
      "A ritual in considered layers.",
      "Begin with water, follow with texture, and finish slowly.",
      4,
    ],
    [
      "section-gifting",
      ...
      "editorial",
      "A considered gift.",
      "Build a ritual for birthdays, thank-yous, or simply because care is worth sharing.",
      5,
    ],
    [
      "section-social",
      ...
      "gallery",
      "Follow the ritual.",
      "Botanical studies, familiar textures and care held close.",
      6,
    ],
    [
      "section-newsletter",
      ...
      "Occasional product rituals and stories, sent with care.",
      7,
    ],
  ] as const;
  ...
  productionProductSeeds.forEach((product, productIndex) => {
    statements.push(
      ...
      db
        ...
        .bind(
          `media-${product.id}-editorial`,
          product.id,
          product.editorial,
          `${product.name} editorial`,
          product.editorialPosition ?? "center",
        ),
    );
    product.benefits.forEach((benefit, index) => {
      statements.push(
        db
          .prepare(
            "INSERT OR IGNORE INTO product_benefits (id, product_id, benefit, sort_order) VALUES (?, ?, ?, ?)",
          )
          .bind(
            `benefit-${product.id}-${index + 1}`,
            product.id,
            benefit,
            index + 1,
          ),
    ...
    product.storyImages.forEach((story, index) => {
      statements.push(
        ...
        VALUES (?, ?, 'STORY', ?, ?, ?, ?, ?, ?, ?)`,
          ...
          .bind(
            `media-${product.id}-story-${index + 1}`,
            product.id,
            story.image,
            story.alt,
            story.eyebrow,
  ...
  statements.push(
    ...
    ...giftBundleStatements(db),
    db.prepare(
      "INSERT OR REPLACE INTO app_state (key, value, updated_at) VALUES ('schema_version', '3', unixepoch())",
    ),
    db.prepare(
      "INSERT OR REPLACE INTO app_state (key, value, updated_at) VALUES ('production_content_seed', '1', unixepoch())",
    ),
  );
...
function giftBundleStatements(db: D1Database): D1PreparedStatement[] {
  return [
    db.prepare(`INSERT OR IGNORE INTO bundle_step_options
      (id, step_id, product_variant_id, enabled, is_default, price_adjustment_minor, sort_order)
      VALUES ('option-gift-soap', 'gift-set-cleanse', 'variant-champion-soap', 1, 1, 0, 1)`),
    db.prepare(`INSERT OR IGNORE INTO bundle_step_options
      (id, step_id, product_variant_id, enabled, is_default, price_adjustment_minor, sort_order)
      VALUES ('option-gift-cream', 'gift-set-care', 'variant-body-cream', 1, 1, 0, 1)`),
    db.prepare(`INSERT OR IGNORE INTO bundle_step_options
      (id, step_id, product_variant_id, enabled, is_default, price_adjustment_minor, sort_order)
      VALUES ('option-gift-oil', 'gift-set-care', 'variant-tree-body-oil', 1, 0, 0, 2)`),
    db.prepare(`INSERT OR IGNORE INTO bundle_step_options
      (id, step_id, product_variant_id, enabled, is_default, price_adjustment_minor, sort_order)
      VALUES ('option-gift-travel', 'gift-set-carry', 'variant-tree-body-oil-travel', 1, 1, 0, 1)`),
  ];
}

async function ensureGiftBundle(db: D1Database): Promise<void> {
  await db.batch([
    db.prepare(`INSERT OR IGNORE INTO bundles
      (id, slug, name, title, cta_label, description, selection_mode, pricing_mode, status, sort_order)
      VALUES ('gift-set', 'gift-set', 'Build a gift set', 'Gather three gestures of care.', 'Build a gift set',
